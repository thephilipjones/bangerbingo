...
**Stories:** 14-1 (Near-Bingo Tension Broadcast), 14-2 (Smart Playlist URL Paste + How-to-Share Tip), 14-3 (Reconnect Replay Completeness), 14-4 (WebSocket Origin Check), 14-5 (Overlay Escape + Focus Helper), 14-6 (Lightweight Performance Instrumentation), 14-7 (Multi-Host Onboarding — Error UX + Docs)
